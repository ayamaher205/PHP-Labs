          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4" action="./Validation.php" method="post" enctype="multipart/form-data">

                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                    <div data-mdb-input-init class="form-outline flex-fill mb-0">
                        <label class="form-label" for="form3Example1c" value="<?php echo $user_data['name']?$user_data['name']:'' ?>">Your Name</label>
                    ...
                    <div data-mdb-input-init class="form-outline flex-fill mb-0">
                        ...
                        <input type="text" id="form3Example3c" class="form-control" name="email"
                            value="<?php echo $user_data['email']?$user_data['email'] : '' ?>" />
                                    <p class="text-danger">
                                        <?php
                                        echo $_COOKIE['errorEmail'] ? $_COOKIE['errorEmail'] : " ";
                                        ?>
                                    </p>
                    </div>
                  </div>
                    <label for="sountry">Room No</label>
                            ...
                            <div class="d-flex flex-row align-items-center mb-4">
                              ...
                              <input class="form-control form-control-lg" id="formFileLg" type="file" name="file">
                                 <p class="text-danger">
                                        <?php
                                        echo $_COOKIE['errorImg'] ? $_COOKIE['errorImg'] : " ";
                                        ?>
                                    </p>
                          </div>
                    </div>
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <button type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-success btn-lg mx-5">Register</button>
